...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
        <div class="container">
            <a class="navbar-brand px-3 bg-warning"
                href="https://www.youtube.com/channel/UCyHwOyTkQBgwfWMOrblSUDg"><?php echo $toko ?></a>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="logout.php"
                            ...
                            <span class="text-center d-block pt-2"><i
                                    class="fa fa-sign-out-alt fa-2x"></i></span>Keluar</a>
                    </li>
                </ul>
            </div>
        </div>
